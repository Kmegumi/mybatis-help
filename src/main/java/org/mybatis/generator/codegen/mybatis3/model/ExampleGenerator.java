...
public class ExampleGenerator extends AbstractJavaGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        topLevelClass.addSuperInterface(new FullyQualifiedJavaType("com.megumi.core.base.BaseExample"));
    ...
    private InnerClass getGeneratedCriteriaInnerClass(
        ...
        answer.addSuperInterface(new FullyQualifiedJavaType("com.megumi.core.base.BaseGeneratedCriteria"));
        context.getCommentGenerator().addClassComment(answer,
                introspectedTable);
